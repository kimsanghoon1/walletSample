...
import wallet.dto.event.Exchanged;
...
public class KafkaConverter {
    ...
    public Object convertPayload(Object payload) {
        try {
            ...
            if (abstractEvent.getEventType().equals("Exchanged")) {
                Exchanged exchanged = objectMapper.readValue((String) payload, Exchanged.class);
                return exchanged;
            }
