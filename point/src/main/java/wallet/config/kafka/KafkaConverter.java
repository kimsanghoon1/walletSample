...
import wallet.dto.event.Charged;
import wallet.dto.event.Used;
...
public class KafkaConverter {
    ...
    public Object convertPayload(Object payload) {
        try {
            ...
            if (abstractEvent.getEventType().equals("Charged")) {
                Charged charged = objectMapper.readValue((String) payload, Charged.class);
                return charged;
            }
            else if (abstractEvent.getEventType().equals("Used")) {
                Used used = objectMapper.readValue((String) payload, Used.class);
                return used;
            }
