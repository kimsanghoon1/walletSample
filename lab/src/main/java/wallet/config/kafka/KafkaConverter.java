...
import wallet.dto.event.PointCreated;
...
public class KafkaConverter {
    ...
    public Object convertPayload(Object payload) {
        try {
            ...
            if (abstractEvent.getEventType().equals("PointCreated")) {
                PointCreated pointCreated = objectMapper.readValue((String) payload, PointCreated.class);
                return pointCreated;
            }
