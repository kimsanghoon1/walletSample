...
import wallet.dto.event.CouponBought;
...
public class KafkaConverter {
    ...
    public Object convertPayload(Object payload) {
        try {
            ...
            if (abstractEvent.getEventType().equals("CouponBought")) {
                CouponBought couponBought = objectMapper.readValue((String) payload, CouponBought.class);
                return couponBought;
            }
